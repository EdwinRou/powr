...
def parse_args():
    ...
    parser.add_argument("--sigma", default=0.2, type=float, help="smoothness of the CME kernel function")
    ...
    parser.add_argument("--subsamples", "-subs", default=10_000, type=int, help="Number of subsamples for nystrom kernel",)
    ...
    parser.add_argument("--save-checkpoint-every", "-sce", default=None, const=None, help="Save checkpoint every <save-checkpoint-every> epochs",)
